...
export async function deleteRequest(id: any, tableName?: string) {
...
export async function deleteRequestOfLong(id: string, tableName?: string) {
  return deleteRequest(id, tableName);
}
