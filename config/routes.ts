...
export default [
  {
    ...
    routes: [
...

      {
        ...
        layout: false,
        name: 'mv_user_video',
        component: './app/mv_user_video/mv_user_video_index',
      },
      {
        path: 'mv_generated_video',
        layout: false,
        name: 'mv_generated_video',
        component: './app/mv_generated_video/mv_generated_video_index',
      },
      {
        path: 'mv_generate_scene',
        layout: false,
